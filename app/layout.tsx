...
export const metadata: Metadata = {
  title: "JL Surveying and Services",
  description: "Professional surveying and construction services",
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <meta name="apple-mobile-web-app-title" content="JL Surveying" />
        <meta name="mobile-web-app-capable" content="yes" />
        <meta name="application-name" content="JL Surveying" />
